     ...
     <section className="about-me" id="student">
       ...
       <div className="about-me__container">
         <div className="about-me__information">
           ...
           <p className="about-me__characteristic">Я родился и живу в Саратове, 
           ...
           начал заниматься фриланс-заказами и ушёл с постоянной работы.</p>
             <a className="about-me__link" href="https://github.com/StepanBM/movies-explorer-frontend" target="_blank" rel="noreferrer">Github</a>
         </div>
